trigger TDTM_ZumzumSalesInvoice on  Zumzum__Sales_Invoice__c (before delete, before insert, before update, after delete, after insert, after undelete, after update) {
